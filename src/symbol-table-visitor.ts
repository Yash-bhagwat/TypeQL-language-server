...
import {FunctionDeclarationContext, VariableDeclarationContext} from "./TypeQLParser";

export class SymbolTableVisitor extends AbstractParseTreeVisitor<SymbolTable> implements TypeQLVisitor<SymbolTable> {
    constructor(
