...
export class TypeQLLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(TypeQLLexer._LITERAL_NAMES, TypeQLLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(TypeQLLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return TypeQLLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return TypeQLLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return TypeQLLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return TypeQLLexer.modeNames; }
	...
	private static readonly _serializedATNSegment1: string =
		"\u020D\u020E\x07k\x02\x02\u020E\u020F\x07p\x02\x02\u020F\u0210\x07i\x02" +
	...
	public static get _ATN(): ATN {
		if (!TypeQLLexer.__ATN) {
			TypeQLLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(TypeQLLexer._serializedATN));
		}
